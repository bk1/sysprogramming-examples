...
int main(int argc, char *argv[]) {
  ...
  result = WriteConsole(fh1, /* _In_        HANDLE hConsoleOutput, */
                        (void *) msg, /*   _In_        const VOID *lpBuffer, */
                        (DWORD) strlen(msg), /*   _In_        DWORD nNumberOfCharsToWrite, */
                        &nWritten, /*   _Out_       LPDWORD lpNumberOfCharsWritten, */
                        NULL); /* _Reserved_  LPVOID lpReserved */
