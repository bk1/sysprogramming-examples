...
processes/daemonize-group-signal: processes/daemonize-group-signal.c lib/libitsky.a include/itskylib.h
	gcc $(CFLAGS) processes/daemonize-group-signal.c $(LIBS) -o processes/daemonize-group-signal
